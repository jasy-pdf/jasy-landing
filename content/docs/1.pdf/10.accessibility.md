---
title: Accessibility
description: Emit a tagged, PDF/UA-1 accessible PDF that screen readers can navigate - it passes veraPDF's machine checks. One flag, plus a role here and there.
navigation:
  title: Accessibility
---
...
Image("chart.png", { alt: "Revenue by region, Q3" });
```
