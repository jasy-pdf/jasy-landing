...
Bookmark(
  { title: "2.1 Requirements", level: 2 },
  Text("2.1 Requirements", { size: 16, bold: true }),
);
```
...
A chapter heading usually wants to be a sidebar entry _and_ a jump target. Nest them, and it is both:
