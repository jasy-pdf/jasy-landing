---
title: Pages
description: Page size, orientation and margins, repeating headers and footers, page numbers, and automatic pagination.
navigation:
  title: Pages
---
...
```ts
Page({ footer: Row({ justify: "center" }, [Text("Page "), PageNumber(), Text(" of "), PageCount()]) }, [
  Column(body),
]);
```
