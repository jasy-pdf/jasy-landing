...
const doc = Document([
  Page({ size: "A4", orientation: "landscape", margin: 46, justify: "center", align: "center" }, [
    ...
    Positioned(
      ...
      Box({ border: gold, borderWidth: 1.5, radius: 6 }, []),
    ),
    ...
    Padding(
      ...
      Column({ align: "center", gap: 0 }, [
        ...
        Box({ height: 26 }, []),
        Text("in recognition of building jasy, a declarative PDF engine in pure TypeScript,", {
          font: "Times-Roman",
          size: 12,
          color: ink,
          align: "center",
        }),
        Text("ZUGFeRD-conformant, with no headless browser and no Java underneath.", {
          font: "Times-Roman",
          size: 12,
          color: ink,
          align: "center",
        ...
        Row({ justify: "between", align: "end" }, [
          Column({ align: "center", gap: 3 }, [
            rule(160),
            Text("Erika Muster · Founder", { font: "Times-Roman", size: 9, color: muted }),
          ]),
          Box({ width: 18, height: 18, radius: 9, border: gold, borderWidth: 1.5 }, []),
          Column({ align: "center", gap: 3 }, [
            rule(160),
            Text("Berlin · 24 June 2026", { font: "Times-Roman", size: 9, color: muted }),
          ]),
        ]),
      ]),
    ),
